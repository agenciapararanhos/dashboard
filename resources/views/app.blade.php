...
<body>
	<nav class="navbar navbar-expand-md navbar-light">
		<a class="navbar-brand" href="/">
			<img src="https://agenciaparanhos.com.br/assets/img/brand-light.png" style="width: 10%;position: fixed;bottom: 10%" title="Logo">
		</a>
				...
				@else
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="{{ route('aimeos_shop_account',['site'=>Route::current()->parameter('site','default'),'locale'=>Route::current()->parameter('locale','pt'),'currency'=>Route::current()->parameter('currency','EUR')]) }}" title="{{ __('Profile') }}">{{ __('Profile') }}</a></li>
	...
	<footer class="mt-5 p-5">
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<div class="col-sm-6 my-4"><h2>{{ __('SOBRE A GENTE') }}</h2><p><a href="http://agenciaparanhos.com.br/">http://agenciaparanhos.com.br/</a></p></div>
				</div>
			</div>
