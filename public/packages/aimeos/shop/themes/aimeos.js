 ...
 * @copyright (agenciaparanhos.com.br), 2020
 */
 ...
 */
 ...
 // CONFIG RÁPIDAS
$('.logo, .locale-select-language, .locale-select-currency').hide();
$('.stage-item').html('<img src="https://wallpapercave.com/wp/wp1819365.jpg"></img>');
$('.home-name').text("ALGO");
document.title="Teste Dashboard";
Aimeos = {
